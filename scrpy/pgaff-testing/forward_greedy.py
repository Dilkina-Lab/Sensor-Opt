...
# def forward_greedy_max_en(scenarios, trap_locs, ac_locs, K, distances, budget=60):
#     """
...
# trap_coords_list = np.load('./secr/Backward Greedy/BG4/considered_trap_locs.npy')         # If needed, upload an existing considered traps - keep consistent with backward greedy considered locations
...
# trap_coords_list_df.to_csv('./secr/Forward Greedy/FG3/considered_trap_locs.csv', index=False)
...
# # Save the results
# np.save('./secr/Forward Greedy/FG3/all_selected_traps.npy', selected_traps)
# # Save the expected number of detections history
# with open('./secr/Forward Greedy/FG3/en_hist.pkl', 'wb') as f:
#     pickle.dump(en_hist, f)
# # Save the trap_x configuration
# with open('./secr/Forward Greedy/FG3/considered_trap_locs.pkl', 'wb') as f:
...
trap_coords_list_sub_df.to_csv('secr/Forward Greedy/FG3/selected_traps.csv', index=True)
...
# convert to txt file
with open('secr/Forward Greedy/FG3/FG3-excluded_traps.txt', 'w') as f:
