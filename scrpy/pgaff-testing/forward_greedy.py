...
params_ids =  [66, 8, 33, 49, 26, 87, 64, 84, 19, 72]
...
with open('secr/Sample Average Approximation/SA1/SA1-20/runtime.txt', 'w') as f:
...
# Save the results
np.save('./secr/Sample Average Approximation/SA1/SA1-20/all_selected_traps.npy', selected_traps)
# Save the expected number of detections history as a txt file
with open('./secr/Sample Average Approximation/SA1/SA1-20/en_hist.txt', 'w') as f:
    for en in en_hist:
        f.write(f"{en}\n")
# Save the trap_x configuration
with open('./secr/Sample Average Approximation/SA1/SA1-20/considered_trap_locs.pkl', 'wb') as f:
...
# Pathsx
base_dir = './secr/Sample Average Approximation/SA1/SA1-20'
...
for n_cams in [10, 20, 30, 40, 50, 60]:
    ...
    excluded_txt_path = f'{base_dir}/SA1-20-excluded_traps-{n_cams}.txt'
