...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SAA8/Budget = 50/IP-excluded_ids-budget50-SA4.txt", col.names = "Trap_index")
...
file_name <- paste0("IP5-50traps_SA4_test_RSE.csv")
