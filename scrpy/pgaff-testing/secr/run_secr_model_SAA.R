...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SAA8/Budget = 10/IP-excluded_ids-budget10-SA4.txt", col.names = "Trap_index")
...
file_name <- paste0("IP5-10traps_SA4_test_RSE.csv")
