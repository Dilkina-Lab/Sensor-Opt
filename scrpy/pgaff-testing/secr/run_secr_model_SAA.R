...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SAA8/Budget = 60/IP-excluded_ids-budget60-SA14.txt", col.names = "Trap_index")
...
file_name <- paste0("IP5-60traps_SA14_test_RSE.csv")
