...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SAA8/Budget = 20/IP-excluded_ids-budget20-SA1.txt", col.names = "Trap_index")
...
file_name <- paste0("IP5-20traps_SA1_val_RSE.csv")
