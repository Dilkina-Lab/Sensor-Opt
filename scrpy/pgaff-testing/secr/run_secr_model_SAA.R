...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SAA7/Budget = 50/IP-excluded_ids-budget50-SA8.txt", col.names = "Trap_index")
...
file_name <- paste0("IP4-50traps_SA8_test_RSE.csv")
