...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SAA8/Budget = 20/IP-excluded_ids-budget20-SA4.txt", col.names = "Trap_index")
...
file_name <- paste0("IP5-20traps_SA4_test_RSE.csv")
