...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SA4/Budget = 80/SA7_Run0/IP-excluded_ids-run0-budget80-SA7.txt", col.names = "Trap_index")
...
file_name <- paste0("IP-80traps_SA7_val_RSE.csv")
