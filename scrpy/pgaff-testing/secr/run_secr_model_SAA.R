...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SA1/SA1-16/SA1-16-excluded_traps-80.txt", col.names = "Trap_index")
...
# Save results
file_name <- paste0("SA1-16_80traps_", start_draw, "-", end_draw, ".csv")
