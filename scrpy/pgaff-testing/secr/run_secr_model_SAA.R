...
exclude_traps <- read.table("SensorOpt/secr/Sample Average Approximation/SA1/SA1-1/SA1-1-excluded_traps-10.txt", col.names = "Trap_index")
...
# Save results
file_name <- paste0("SA1-1_10traps_", start_draw, "-", end_draw, ".csv")
