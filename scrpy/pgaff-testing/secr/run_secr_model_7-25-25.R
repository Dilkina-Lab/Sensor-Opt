...
exclude_traps <- read.table("SensorOpt/secr/Forward Greedy/FG23/FG23-excluded_traps.txt", col.names = "Trap_index")
...
file_name <- paste0("FG23_", start_draw, "-", end_draw, ".csv")
