...
exclude_traps <- read.table("SensorOpt/secr/Forward Greedy/FG18/FG18-excluded_traps.txt", col.names = "Trap_index")
...
file_name <- paste0("FG18_", start_draw, "-", end_draw, ".csv")
