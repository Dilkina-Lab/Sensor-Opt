...
exclude_traps <- read.table("SensorOpt/secr/Forward Greedy/FG20/FG20-excluded_traps.txt", col.names = "Trap_index")
...
file_name <- paste0("FG20_", start_draw, "-", end_draw, ".csv")
