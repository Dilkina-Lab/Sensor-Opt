...
exclude_traps <- read.table("SensorOpt/secr/Forward Greedy/FG34/FG34-excluded_traps.txt", col.names = "Trap_index")
...
file_name <- paste0("FG34_", start_draw, "-", end_draw, ".csv")
