...
traps_to_remove <- read.csv("SensorOpt/secr/traps_to_remove_Robin.csv")  # UPDATED -- Comment out if not needed.
...
########################## Make a mask #########################################
gcs_get_object("sim_update_6-9-2025/param_values_for_each_draw150_7-21-25.csv", 
