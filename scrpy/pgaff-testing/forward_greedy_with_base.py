...
#     with open('./secr/Forward Greedy/FG34/n_tracker.txt', 'w') as f:
...
trap_df.to_csv('./secr/Forward Greedy/FG34/considered_trap_locs.csv', index=False)
...
with open('./secr/Forward Greedy/FG34/runtime.txt', 'w') as f:
...
# Save results
np.save('./secr/Forward Greedy/FG34/all_selected_traps.npy', selected_traps)
with open('./secr/Forward Greedy/FG34/en_hist.txt', 'w') as f:
    for e in en_hist:
        f.write(f"{e}\n")
with open('./secr/Forward Greedy/FG34/considered_trap_locs.pkl', 'wb') as f:
...
final_df.to_csv('./secr/Forward Greedy/FG34/selected_traps.csv', index=False)
...
with open('./secr/Forward Greedy/FG34/FG34-excluded_traps.txt', 'w') as f:
