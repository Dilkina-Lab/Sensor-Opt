...
trap_df.to_csv('./secr/Forward Greedy/FG53/considered_trap_locs.csv', index=False)
...
# Save results
np.save('./secr/Forward Greedy/FG53/all_selected_traps.npy', selected_traps)
with open('./secr/Forward Greedy/FG53/en_hist.txt', 'w') as f:
    for e in en_hist:
        f.write(f"{e}\n")
